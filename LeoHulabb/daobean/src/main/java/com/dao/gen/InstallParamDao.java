...
*/
public class InstallParamDao extends AbstractDao<InstallParam, Long> {

    public static final String TABLENAME = "InstallParam";

    /**
     * Properties of entity InstallParam.<br/>
    ...
    */
    ...
    public InstallParamDao(DaoConfig config) {
        super(config);
    }
    
    public InstallParamDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, InstallParam entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public InstallParam readEntity(Cursor cursor, int offset) {
        InstallParam entity = new InstallParam( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, InstallParam entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(InstallParam entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(InstallParam entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
