package com.commonui.imageview.lean;
...
public class LeanImageView extends ImageView {
    ...
    int diagonalGravity = LeanImageView.LEFT;
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        TypedArray styledAttributes = getContext().obtainStyledAttributes(attrs, R.styleable.LeanImageView, 0, 0);
        angle = styledAttributes.getInt(R.styleable.LeanImageView_angle, 0);
        if (styledAttributes.hasValue(R.styleable.LeanImageView_diagonalGravity)) {
            diagonalGravity = styledAttributes.getInt(R.styleable.LeanImageView_diagonalGravity, 0);
        }
        if  (styledAttributes.hasValue(R.styleable.LeanImageView_horizontalShift)) {
            shift = (int) styledAttributes.getDimension(R.styleable.LeanImageView_horizontalShift, 0);
        }
