package com.commonui.loadingview;
...
public class LoadingTip extends LinearLayout {
    ...
    public static enum LoadStatus {
        sereverError, error, errorTry, empty, loading, finish
    }

    private void initView(Context context) {
        View.inflate(context, R.layout.base_loading_layout, this);
    ...
    public void setLoadingTip(LoadStatus loadStatus){
        switch (loadStatus){
            case empty:
                ...
                tv_tips.setText(Constant.EMPTY_TITLE);
                img_tip_logo.setImageResource(R.drawable.bg_square_no);
                break;
            case sereverError:
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);
                ...
                if (TextUtils.isEmpty(errorMsg)){
                    tv_tips.setText(Constant.ERROR_TITLE);
                }else {
                    tv_tips.setText(errorMsg);
                }
                img_tip_logo.setImageResource(R.drawable.bg_square_error);
                break;
            case error:
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);
