...
import com.commonui.animation.AlphaInAnimation;
import com.commonui.animation.BaseAnimation;
import com.commonui.animation.CustomAnimation;
import com.commonui.animation.ScaleInAnimation;
import com.commonui.animation.SlideInBottomAnimation;
import com.commonui.animation.SlideInLeftAnimation;
import com.commonui.animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
            return createBaseViewHolder(parent, R.layout.base_list_loading);
        }
