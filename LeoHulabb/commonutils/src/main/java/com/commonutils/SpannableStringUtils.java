...
public class SpannableStringUtils
{
    ...
    public static Builder getBuilder(@NonNull CharSequence text, Context context) {
        SpannableStringUtils.context = context;
    ...
    public static class Builder {
         ...
         * 设置字体大小
         *
         * @param absoluteSize 字体大小
         * @return {@link Builder}
         */
        public Builder setAbsoluteSize(int absoluteSize) {
        ...
        private void setSpan() {
            ...
            if (absoluteSize != -1) {
                mBuilder.setSpan(new AbsoluteSizeSpan(absoluteSize), start, end, flag);
                absoluteSize = -1;
            }
            if (xProportion != -1) {
